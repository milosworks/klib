...
import xyz.milosworks.klib.ui.modifiers.layout.SizeModifier
    ...
    Layout(
        ...
        renderer = object : DefaultRenderer() {
            override fun render(
                ...
                val textColor = if (enabled) KColor.Companion.WHITE.argb else KColor.Companion.GRAY.argb
                ...
                if (placeholder != null && displayedText.isEmpty() && !focused) {
                    guiGraphics.drawString(font, placeholder, textDrawX, startY, KColor.Companion.GRAY.argb)
                }
