...
class TextFieldState {
    // Character index, single-line scroll
    var displayPos by mutableStateOf(0)

    // For multi-line scroll, pixel value
    ...
    // Layout information needed for calculations
...
fun TextFieldCore(
    ...
    val scrollToCursor = {
        ...
        if (nodeWidth <= 0 || nodeHeight <= 0) { /* Do nothing if not measured yet */
        } else if (singleLine) {
