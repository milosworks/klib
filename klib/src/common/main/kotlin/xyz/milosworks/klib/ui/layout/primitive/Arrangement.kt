...
import xyz.milosworks.klib.ui.layout.primitive.Arrangement.spacedBy
import kotlin.math.min
import kotlin.math.roundToInt

/**
 * Used to specify the arrangement of the layout's children in layouts like [xyz.milosworks.klib.ui.layout.containers.Row] or [xyz.milosworks.klib.ui.layout.containers.Column] in
 * the main axis direction (horizontal and vertical, respectively).
 *
 * Below is an illustration of different horizontal arrangements in [xyz.milosworks.klib.ui.layout.containers.Row]s:
 ...
 *
 * Different vertical arrangements in [xyz.milosworks.klib.ui.layout.containers.Column]s:
...
object Arrangement {
    /**
     * Used to specify the horizontal arrangement of the layout's children in layouts like [xyz.milosworks.klib.ui.layout.containers.Row].
     */
    @Stable
    ...
    /**
     * Used to specify the vertical arrangement of the layout's children in layouts like [xyz.milosworks.klib.ui.layout.containers.Column].
     */
    @Stable
    interface Vertical {
        /**
     ...
     * like [xyz.milosworks.klib.ui.layout.containers.Row], or the vertical arrangement of the layout's children in vertical layouts like
     * [xyz.milosworks.klib.ui.layout.containers.Column].
     */
    @Stable
    ...
    fun aligned(alignment: Alignment.Horizontal): Horizontal =
        SpacedAligned(0, true) { size, layoutDirection ->
            alignment.align(0, size, layoutDirection)
        }
    ...
    fun aligned(alignment: Alignment.Vertical): Vertical =
        SpacedAligned(0, false) { size, _ -> alignment.align(0, size) }

    @Immutable
    object Absolute {
        /**
         * Place children horizontally such that they are as close as possible to the left edge of
         * the [xyz.milosworks.klib.ui.layout.containers.Row].
         *
         * Unlike [Arrangement.Start], when the layout direction is RTL, the children will not be
         * mirrored and as such children will appear in the order they are composed inside the [xyz.milosworks.klib.ui.layout.containers.Row].
         *
         * Visually: 123####
         */
        @Stable
        ...
        /**
         * Place children such that they are as close as possible to the middle of the [xyz.milosworks.klib.ui.layout.containers.Row].
         *
        ...
        @Stable
        fun aligned(alignment: Alignment.Horizontal): Horizontal =
            SpacedAligned(0, false) { size, layoutDirection ->
                alignment.align(0, size, layoutDirection)
            }
    }
