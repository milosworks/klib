        ...
        renderer = object : Renderer {
            override fun render(
                ...
                guiGraphics.drawRectOutline(
                    x + (saturation * node.width).toInt() - 2,
                    y + ((1 - value) * node.height).toInt() - 2,
                    4,
                    4,
                    KColor.WHITE.argb
                )
        ...
        renderer = object : Renderer {
            override fun render(
                ...
                for (j in 0 until node.height) {
                    val currentHue = 1f - (j.toFloat() / node.height)
                    guiGraphics.fill(
                        x,
                        y + j,
                        x + node.width,
    ...
    Layout(
        ...
        renderer = object : Renderer {
            override fun render(
                ...
                guiGraphics.drawRectOutline(
                    x + (color.alpha * node.width).toInt() - 1,
                    y - 1,
                    3,
                    node.height + 2,
                    KColor.WHITE.argb
